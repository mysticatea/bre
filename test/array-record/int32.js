...
describe("defineArrayRecord:", () => {
    describe("Record with 'int32' and 2", () => {
        const Record = defineArrayRecord("int32", 2)
        let buffer = null
        let record = null
        ...
        it("should throw if it wrote 2147483648 (out of range)", () => {
            for (const k of record.keys()) {
                assert(thrownMessage(() => {
                    record[k] = 2147483648
                }) === `'${k}' should be within '-2147483648..2147483647', but got 2147483648.`)
            }
        })
        ...
        it("should throw if it wrote -2147483649 (out of range)", () => {
            for (const k of record.keys()) {
                assert(thrownMessage(() => {
                    record[k] = -2147483649
                }) === `'${k}' should be within '-2147483648..2147483647', but got -2147483649.`)
            }
        })
