...
describe("defineObjectRecord with NodejsBufferTextEncoder:", () => {
    setTextEncoder(require("../../lib/text-encoders/buffer"))

    describe("Record with 1 'string(15)' field", () => {
        const Record = defineObjectRecord("String15", [
    ...
    describe("Record with 1 'utf8(15)' field", () => {
        const Record = defineObjectRecord("UTF8_15", [
            {type: "utf8(15)", name: "a"},
        ])
        let buffer = null
        let record = null
