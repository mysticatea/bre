...
/**
 * Define empty array record.
 * @returns {class} Defined class.
 * @private
 */
function defineEmptyArrayRecord() {
    const ArrayRecord = Function("BinaryRecord", `
"use strict"
return class EmptyArrayRecord extends BinaryRecord {
    constructor(buffer, byteOffset) {
        super(buffer, byteOffset)
    }

    static view(buffer, byteOffset) {
        return Object.freeze(new EmptyArrayRecord(buffer, byteOffset))
    }
    ...
    * [Symbol.iterator]() {
    ...
    return installArrayMethods(ArrayRecord, true)
}
